...
- [Tanzu Application Platform v1.5](overview.hbs.md)
...
- [Installation](install-intro.hbs.md)
  ...
  - [Online install](online-install-intro.hbs.md)
      - [Install overview](online-install-intro.hbs.md)
      - [Install packages and profiles](install.hbs.md)
      - [View package config settings](view-package-config.hbs.md)
      - [Install individual packages](install-components.hbs.md)
      - [Set up namespaces](set-up-namespaces.hbs.md)
  ...
  - [Air-gapped install](offline-install-intro.hbs.md)
      - [Install overview](offline-install-intro.hbs.md)
      - [Install packages and profiles](install-air-gap.hbs.md)
      ...
      - [Use Grype](grype-offline-airgap.hbs.md)
      - [Set up namespaces](set-up-namespaces-offline.hbs.md)
  - [Install on AWS Cloud](aws-install-intro.hbs.md)
      - [Install overview](aws-install-intro.hbs.md)
      - [Create AWS Resources](aws-resources.hbs.md)
      - [Install packages and profiles](install-aws.hbs.md)
      - [View package config settings](view-package-config-aws.hbs.md)
      - [Install individual packages](install-components-aws.hbs.md)
      - [Set up namespaces](set-up-namespaces-aws.hbs.md)
      - [Install Tanzu Developer Tools for VS Code](vscode-install-aws.hbs.md)
  - [Install on OpenShift clusters](openshift-install-intro.hbs.md)
...
- [Component documentation](components.hbs.md)
    ...
    - [Learning Center](learning-center/about.hbs.md)
      ...
      - [Get started](learning-center/getting-started/about.hbs.md)
          ...
          - [Learning Center operator](learning-center/getting-started/learning-center-operator.hbs.md)
          ...
          - [TrainingPortal](learning-center/getting-started/training-portal.hbs.md)
    ...
    - [Supply Chain Choreographer](scc/about.hbs.md)
      ...
      - [How-to guides for Supply Chain Choreographer](scc/scc-how-to.hbs.md)
